...
{block name="page"}
	...
	<tabs :track-history="true">
		...
		<tab id="certificate" label="{translate key="about.contact"}">
			{help file="settings/journal-settings" section="certificate" class="pkp_help_tab"}
			<pkp-form
				v-bind="components.{$smarty.const.FORM_EXPORT_REVIEWER_CERTIFICATE}"
				@set="set"
			/>
		</tab>
	</tabs>
