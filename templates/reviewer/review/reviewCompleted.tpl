...
<div class="actions">
    <a href="{url page="reviewer" op="download" submission=$submission->getId()}" target="_BLANK" title="{translate key="plugins.generic.exportReviewerCertificate.button.title" }">{translate key="plugins.generic.exportReviewerCertificate.button"}</a>
</div>
</div>